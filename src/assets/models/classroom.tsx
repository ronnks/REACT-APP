...
export default class Classroom {
    constructor(private name: string, private teacher: Teacher, private studentsList: Student[], private assignmentsList: Assignment[]){
        this.name = name;
    ...
    toString(){
        return "name: "+this.name+" teacher: "+this.teacher+" studentsList: "+this.studentsList+" assignmentsList: "+this.assignmentsList;
    }
  }